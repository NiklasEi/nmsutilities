 ...
 * Created by niklas
 */
public class NmsUtility_1_16_R3 implements NmsUtility {
    @Override
    public void updateInventoryTitle(Player player, String newTitle) {
        ...
        final PacketPlayOutOpenWindow packet = new PacketPlayOutOpenWindow(entityPlayer.activeContainer.windowId,
                WindowType_1_16_R3.guessBySlots(entityPlayer.activeContainer.getBukkitView().getTopInventory().getSize()).getType()
